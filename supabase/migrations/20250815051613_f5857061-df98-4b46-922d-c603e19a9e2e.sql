-- Drop existing notification policies that depend on is_admin
...
-- Set the super admin and convert existing is_admin values
UPDATE public.profiles 
SET role = CASE 
  WHEN email = 'contato@vivazagencia.com.br' THEN 'super_admin'::public.user_role
  WHEN is_admin = true THEN 'admin'::public.user_role
  ELSE 'user'::public.user_role
END
WHERE role = 'user'; -- Only update if still default
...
-- Create new notifications policies using new role system
